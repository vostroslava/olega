...
export function ProductionPage() {
  const principles = [
    ["Собственное производство", "Проектирование, изготовление и контроль качества связаны одной командой."],
  ...
  return (
    <div className="page-shell">
      ...
      <main className="page-main monolith-inner-page">
        <MonolithPageHero id="production-hero" breadcrumbs={[{ label: "Главная", href: "/" }, { label: "Производство" }]} title="Точность начинается на производстве" lead="Собственное производство помогает сохранить архитектурную идею, геометрию конструкции и качество монтажа." image="/assets/photos/company-production.png" imageAlt="Производство СтеклоСтройГрупп" rail={["Производство", "Этапы", "Контроль", "Команда", "Расчёт"]} />

        <section className="monolith-content-section" id="section-1">
          <div className="container production-page-intro">
            <MonolithSectionHeading label="ПРОИЗВОДСТВО" title="От технической идеи до готовой конструкции" text="Мы не отделяем красивую картинку от производства. Система, стеклопакет, профиль, фурнитура и монтажный узел рассматриваются как единое изделие." />
