    ...
    <div className="page-shell">
      ...
      <main className="page-main">
        <section className="page-hero section">
          <div className="container page-hero-shell reveal" id="contacts-hero">
            <div className="page-hero-copy">
              ...
              <h1>Страница, с которой удобно и позвонить, и отправить запрос</h1>
              <p className="hero-lead">
                Здесь не должно быть тупика. Контакты, реквизиты, карта и форма заявки должны
                работать как один понятный сценарий связи.
              </p>
              <p className="page-hero-text">
                Свяжитесь удобным способом: звонок, email, заявка через сайт или маршрут до офиса.
              </p>
        ...
        <RequestSection
          ...
          description="Эта форма нужна как быстрый вход в диалог, а не как длинный опросник. Имя, телефон и краткое описание задачи достаточно для первого контакта."
        />
      </main>
