      ...
      <main className="page-main monolith-inner-page">
        ...
        <section className="monolith-content-section" id="section-1">
          <div className="container about-manifest-grid">
            <MonolithSectionHeading label="КОМПАНИЯ" title="Архитектурная идея должна пережить производство и монтаж" text="Поэтому проектирование, комплектация, изготовление, логистика и установка работают как один цикл — с понятной ответственностью на каждом этапе." />
        ...
        <section className="monolith-content-section monolith-content-section-alt" id="section-4">
          <div className="container">
            <MonolithSectionHeading label="ДОКУМЕНТЫ" title="Сертификаты и подтверждение компетенций" text="Публичные документы собраны в одном месте, чтобы заказчик мог проверить сертификаты и компетенции без лишнего поиска." />
        ...
        <MonolithCta title="Познакомимся на вашем объекте" text="Расскажите о задаче — команда подключит инженера и определит следующий шаг: исходные данные, замер или техническую консультацию." />
      </main>
      <SiteFooter />
      <RevealInit />
