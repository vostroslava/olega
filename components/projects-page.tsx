        ...
        <section className="page-hero section">
          <div className="container page-hero-shell reveal" id="projects-hero">
            <div className="page-hero-copy">
              ...
              <h1>Проекты, в которых сайт показывает масштаб и реальную компетенцию</h1>
              <p className="hero-lead">
                От торговых и медицинских комплексов до объектов со сложной внутренней
                стеклянной архитектурой. Здесь важно показать не каталог, а выполненную работу.
              </p>
              <p className="page-hero-text">
                На странице проектов клиент должен считывать уверенность: компания умеет доводить
                объект от расчёта и производства до монтажа и финальной сдачи.
              </p>
            ...
            <aside className="page-hero-panel reveal reveal-delay">
              <strong>Что важно на странице кейсов</strong>
              <ul className="page-highlight-list">
                <li>Показывать масштаб, а не просто картинки</li>
                <li>Связывать кейс с конкретной услугой</li>
                <li>Закрывать путь в заявку без лишних экранов</li>
              </ul>
            </aside>
          </div>
        </section>
        ...
        <section className="section projects-overview">
          <div className="container">
            <SectionHeading
              ...
              description="Даже простая фильтрация помогает быстрее соотнести кейс с задачей клиента и усилить путь в заявку."
            />
